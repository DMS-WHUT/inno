...
//  Button actions -----------------------------------------------------------------------------------------------------
  ...
  window.configureMicrophone = function () {
    document.getElementById("mp_config").style.display="none";
    document.getElementById("prompt_info").style.display="table";
...
function mpConfig(){
  document.getElementById("mp_config").style.display="table";
